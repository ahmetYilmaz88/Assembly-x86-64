...
mov edx, 400000
mov [doubleAnswer1], edx
; 2. doubleAnswer2 = doubleVariable2
mov ebx, dword[doubleVariable2]
mov dword [doubleAnswer2],ebx

;=====MOVZX=====
; 3. quadAnswer3 = byteVariable3
movzx rcx, byte[byteVariable3]
mov qword[quadAnswer3],rcx
; 4. quadAnswer4 = doubleVariable4
movsxd eax, dword[doubleVariable4]
mov dword[quadAnswer4],eax

;=====MOVSX=====
; 5. quadAnswer5 = doubleVariable5
movsxd eax, dword[doubleVariable5]
mov dword[quadAnswer5],eax
...
mov dx, word[wordVariable6a]
add dx, word[wordVariable6b]
mov word[wordAnswer6], dx
...
sub ebx, dword[wordVariable9]
mov dword[doubleAnswer9], ebx
...
; mov word [wordAnswer16], al ---Not required
...
mov edx, word[quadVariable20+2]
idiv eax
;mov dword [doubleAnswer20], eax --> Not Required
